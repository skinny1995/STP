...
HIDDEN_UNITS = [22, 22, 10]  # 节点数，隐藏层数
...
test_dataframe = dataframe.tail(74000)  # 取后4013个数据
max_min_scaler = lambda x : (x-np.min(x))/(np.max(x)-np.min(x))
train_dataframe[['xSrcPort']] =train_dataframe[['xSrcPort']].apply(max_min_scaler)
train_dataframe[['xDstPort']] =train_dataframe[['xDstPort']].apply(max_min_scaler)
train_dataframe[['xPkt']] =train_dataframe[['xPkt']].apply(max_min_scaler)
train_dataframe[['xMin_Pbyte0']] =train_dataframe[['xMin_Pbyte0']].apply(max_min_scaler)
train_dataframe[['xMin_Pbyte1']] =train_dataframe[['xMin_Pbyte1']].apply(max_min_scaler)
train_dataframe[['xMax_Pbyte0']] =train_dataframe[['xMax_Pbyte0']].apply(max_min_scaler)
train_dataframe[['xMax_Pbyte1']] =train_dataframe[['xMax_Pbyte1']].apply(max_min_scaler)
train_dataframe[['xIni_Pbyte0']] =train_dataframe[['xIni_Pbyte0']].apply(max_min_scaler)
train_dataframe[['xMax_ConsPkt0']] =train_dataframe[['xMax_ConsPkt0']].apply(max_min_scaler)

test_dataframe[['xSrcPort']] =test_dataframe[['xSrcPort']].apply(max_min_scaler)
test_dataframe[['xDstPort']] =test_dataframe[['xDstPort']].apply(max_min_scaler)
test_dataframe[['xPkt']] =test_dataframe[['xPkt']].apply(max_min_scaler)
test_dataframe[['xMin_Pbyte0']] =test_dataframe[['xMin_Pbyte0']].apply(max_min_scaler)
test_dataframe[['xMin_Pbyte1']] =test_dataframe[['xMin_Pbyte1']].apply(max_min_scaler)
test_dataframe[['xMax_Pbyte0']] =test_dataframe[['xMax_Pbyte0']].apply(max_min_scaler)
test_dataframe[['xMax_Pbyte1']] =test_dataframe[['xMax_Pbyte1']].apply(max_min_scaler)
test_dataframe[['xIni_Pbyte0']] =test_dataframe[['xIni_Pbyte0']].apply(max_min_scaler)
test_dataframe[['xMax_ConsPkt0']] =test_dataframe[['xMax_ConsPkt0']].apply(max_min_scaler)
